...
const baseExerciseDatabase: ExerciseData[] = [
  ...
  { id: 'dumbbell-shoulder-press', name: 'DB Shoulder Press', category: 'Shoulders', targetMuscle: 'Shoulders' },
  ...
  { id: 'cable-lateral-raises', name: 'Cable Lateral Raise', category: 'Shoulders', targetMuscle: 'Side Delts' },
  ...
  { id: 'z-bar-curls', name: 'Z Bar Bicep Curls', category: 'Arms', targetMuscle: 'Biceps' },
  { id: 'dumbbell-curl', name: 'Dumbbell Curl', category: 'Arms', targetMuscle: 'Biceps' },
  { id: 'dumbbell-curls', name: 'DB Bicep Curls', category: 'Arms', targetMuscle: 'Biceps' },
  { id: 'hammer-curl', name: 'Hammer Curl', category: 'Arms', targetMuscle: 'Biceps' },
  { id: 'hammer-curls', name: 'Hammer Curls', category: 'Arms', targetMuscle: 'Biceps' },
  { id: 'preacher-curl', name: 'Preacher Curl', category: 'Arms', targetMuscle: 'Biceps' },
  { id: 'preacher-curls', name: 'Preacher Curls Z Bar', category: 'Arms', targetMuscle: 'Biceps' },
  ...
  { id: 'tricep-pushdowns', name: 'Cable Triceps Pushdown', category: 'Arms', targetMuscle: 'Triceps' },
  ...
  { id: 'overhead-tricep-extension', name: 'Cable Triceps Overhead Extension', category: 'Arms', targetMuscle: 'Triceps' },
  ...
  { id: 'leg-extension', name: 'Leg Extension Machine', category: 'Legs', targetMuscle: 'Quads' },
  { id: 'bulgarian-split-squat', name: 'Bulgarian Split Squat', category: 'Legs', targetMuscle: 'Quads' },
  { id: 'bulgarian-split-squats', name: 'Bulgarian Split Squat Smith Machine', category: 'Legs', targetMuscle: 'Quads' },
  ...
  { id: 'leg-curls', name: 'Hamstring Curls Machine', category: 'Legs', targetMuscle: 'Hamstrings' },
  ...
  { id: 'calf-raises', name: 'Calve Raises Smith Machine', category: 'Legs', targetMuscle: 'Calves' },
