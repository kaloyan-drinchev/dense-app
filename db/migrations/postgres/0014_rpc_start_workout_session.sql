-- ============================================
-- RPC Function: start_workout_session
-- ============================================
-- This function creates a fresh workout session from a template.
-- It clones the template structure into session tables with clean state.
...
-- Add comment
COMMENT ON FUNCTION start_workout_session IS 'Creates a new workout session from a template with fresh state';
